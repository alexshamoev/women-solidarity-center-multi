...
class DefaultMenuButtonsStep0 extends Seeder
{
    ...
    public function run()
    {
        DB :: insert("INSERT INTO `menu_buttons_step_0` (`title_az`, `title_en`, `title_ar`, `page_id`, `created_at`, `updated_at`, `rang`, `free_link_az`, `free_link_en`, `free_link_ar`, `link_type`, `module_step`, `open_in_new_tab`) VALUES
